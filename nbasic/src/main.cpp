...
int main(int argn, char **argv)
{
	...
	if (argn < 2)
	{
		...
		printf("  -verbose      Report more messages\n");
		printf("  -quiet        Report fewer messages\n");
		printf("  -o [filename] Specify output filename out-of-order\n");
		printf("  -stdout       Output asm to console\n");
